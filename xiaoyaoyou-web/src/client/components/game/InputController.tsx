...
export interface InputControllerProps {
  ...
  /** Selected card codes from HandArea */
  ...
  /** Current player's hand card codes */
  hand: string[];
  /** Timeout in seconds */
  timeout?: number;
}
...
const InputController: React.FC<InputControllerProps> = ({
  ...
  const canSubmit = useMemo(() => {
    ...
    return true;
  }, [parsed, selectedTargets, selectedCards, menuSelections, dealSelections, numberSelection, elementSelections]);
    ...
    <div className="input-controller" data-testid="input-controller">
      ...
      <div className="input-controller-status">
        {parsed.segments.map((seg, i) => {
          ...
          else if (seg.type === 'Q') current = selectedCards.length;
